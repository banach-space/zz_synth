...
//  
//  DESCRIPTION:
//      By comparing the pre- and post- envelope samples verifies that
//      conditions that have to be satisfied for every AR envelope are
//      indeed met.
//  INPUT:
//      attack_length         - the length of the attack segment
//      decay_length          - the length of the decay segment
...
//------------------------------------------------------------------------
//  NAME:
//      ComparePreAndPostEnvelopeNonZeroAttack
//  
//  DESCRIPTION:
//      By comparing the pre- and post- envelope samples verifies that
//      conditions that have to be satisfied for an AR envelope with
//      an attack segment longer than zero samples are indeed met.
//  INPUT:
//      attack_length         - the length of the attack segment (has to
//                              be greater than 0)
//      decay_length          - the length of the decay segment
//      samples_pre_envelope  - samples before applying the envelope
//      samples_post_envelope - samples after applying the envelope
        ...
        vector<int16_t> &samples_post_envelope)
{
    ...
    // 4. The second element in the attack segment should be different from the original one. Note that 
    ...
    // 5. The second element in the decay segment should be different from the original one. Note that 
    // special care have to be taken if the original sample was equal to 0. To be more precise, if 
